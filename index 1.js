...
var raja = [
    { id: 1, name:'Varatha',orderdetails: 'Lays' },
    { id: 2, name:'amrith', orderdetails: 'Cheetos'},
    { id: 3, name:'Ram',orderdetails: 'Bingo'},
    { id: 4, name:'Suriya',orderdetails: 'Mad Angeles'},
    { id: 5, name:'Veera',orderdetails: 'Kurkurae'},
];
...
server.delete('/:id', function (req, res) {
    ...
    if (found) {
        ...
        var targetIndex = raja.indexOf(found);

        raja.splice(targetIndex, 1);
    }
